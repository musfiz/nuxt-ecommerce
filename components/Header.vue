...
<template>
  <div class="header-wrapper">
    <div class="header-nav">
      <button class="nav-menu" @click="toggleSideNavbar()">
        <svg style="" xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" class="bi bi-list"
          viewBox="0 0 16 16">
      ...
      <div class="nav-search">
        ...
        <button class="search-btn">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#63666A" class="bi bi-search"
            viewBox="0 0 16 16">
            <path
      ...
      <div class="nav-item locale">
        <span>
          <NuxtLink class="nav-link" to="javascript:void(0)" @click="$i18n.setLocale('en')">EN</NuxtLink> |
          <NuxtLink class="nav-link" to="javascript:void(0)" @click="$i18n.setLocale('bn')"> বাং</NuxtLink>
        </span>
      </div>
      <!-- <div class="nav-item">
      ...
      <div class="nav-item sign-in">
        <NuxtLink class="nav-link" @click="showDialog"> {{ $t('header.signIn') }}</NuxtLink>
      </div>
      <!-- <div class="nav-cart">
